...
#define SHKMyAppName			@"Gravilux"
#define SHKMyAppURL				@"http://snibbe.com/store/gravilux"
...
#define SHKFacebookKey				@"cf7245420e77472fe5988f0ac26ca415"
#define SHKFacebookSecret			@"31aec84430d087e7b7b9539f48985e57"
 ...
 */
#define SHKTwitterConsumerKey		@"lia15BnwUsXV1TZKXXQ"
#define SHKTwitterSecret			@"rCTnC9FFBntszMw2sqanWR7a3KgOXeg7Qy1CEn7Jwg"
#define SHKTwitterCallbackUrl		@"http://snibbe.com/twitter_callback" // You need to set this if using OAuth, see note above (xAuth users can skip it)
